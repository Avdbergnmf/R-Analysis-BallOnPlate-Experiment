...
allComplexityMetrics <- load_or_calculate(complexityMetricsFile, function() get_all_complexity_metrics(allGaitParams, debug = TRUE))

## Plotting code
source('source/plotting.R', local = FALSE)

# for testing combining of tables
#mu_gait <- get_full_mu(allGaitParams, allQResults, categories, TRUE, FALSE)
