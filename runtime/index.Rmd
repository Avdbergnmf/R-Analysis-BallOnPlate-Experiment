...
allQResults <- load_or_calculate(aqrFile, get_all_questionnaire_results, parallel = USE_PARALLEL)
allGaitParams <- load_or_calculate(agpFile, calc_all_gait_params, parallel = USE_PARALLEL)
...
allTaskMetrics <- load_or_calculate(taskMetricsFile, get_all_task_metrics, parallel = USE_PARALLEL)
allComplexityMetrics <- load_or_calculate(complexityMetricsFile, get_all_complexity_metrics, parallel = USE_PARALLEL)
