...
continuousMetricsFile <- file.path(resultsFolder, "allContinuousMetrics.rds")
...
continuousMetrics <- load_or_calculate(continuousMetricsFile, get_all_combined_continuous_metrics, stop_cluster = TRUE)
