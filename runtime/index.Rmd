...
udpTimeTrimInfo <<- load_or_calculate(udpTimeTrimInfoFile, load_or_create_udp_time_trim_info, stop_cluster = TRUE)
...
allGaitParams <<- load_or_calculate(agpFile, calc_all_gait_params, parallel = FALSE)
