...
udpTimeTrimInfo <<- load_or_calculate(udpTimeTrimInfoFile, load_or_create_udp_time_trim_info, parallel = FALSE)

# Load or calculate the data using the global parallel setting
allQResults <- load_or_calculate(aqrFile, get_all_questionnaire_results, parallel = FALSE)
allGaitParams <<- load_or_calculate(agpFile, calc_all_gait_params, parallel = TRUE)
...
allTaskMetrics <- load_or_calculate(taskMetricsFile, get_all_task_metrics, force_recalc = TRUE)
