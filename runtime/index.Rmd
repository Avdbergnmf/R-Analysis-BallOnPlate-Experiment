...
# =============================================================================
# Set to TRUE for faster computation on multi-core systems (recommended for production)
# Set to FALSE for debugging, small datasets, or troubleshooting other issues
USE_PARALLEL <- TRUE 

# =============================================================================
# LOGGING CONTROL
# =============================================================================
# Set to TRUE to enable detailed logging of parallel processing to files
# Set to FALSE to disable file logging for faster processing and cleaner output
ENABLE_FILE_LOGGING <- TRUE
# =============================================================================

# =============================================================================
# FORCE RECALCULATION CONTROL
# =============================================================================
# Set to TRUE to ignore existing cached RDS files and recompute datasets
# each time the pipeline runs. Useful after code changes or when you suspect
# the caches are stale. Set to FALSE to use cached results when available
# for faster startup.
FORCE_RECALC <- FALSE
# =============================================================================
...
allGaitParams <- load_or_calculate(agpFile, calc_all_gait_params, force_recalc = TRUE)
