...
udpPelvisMetricsFile <- file.path(resultsFolder, "udpPelvisMetrics.rds")
...
source("source/udp_metrics.R", local = FALSE)
...
udpPelvisMetrics <- load_or_calculate(udpPelvisMetricsFile, get_all_udp_pelvis_metrics, parallel = FALSE)
