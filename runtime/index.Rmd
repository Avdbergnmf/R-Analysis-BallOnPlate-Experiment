...
FORCE_REGENERATE_SIMULATION_DATA <- FALSE  # Set to TRUE to force regeneration of cached simulation data
...
# Load or calculate enhanced simulation data for all participants and trials
allSimulationData <- get_all_simulation_data_cached(force_regenerate = FORCE_REGENERATE_SIMULATION_DATA)
