...
# Load risk model into global workspace for parallel processing (only if it exists)
...
allTaskMetrics <- load_or_calculate(taskMetricsFile, get_all_task_metrics, parallel = TRUE)
