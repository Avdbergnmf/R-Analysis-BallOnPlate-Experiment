...
if (exists(".TASK_DATA_JUST_CALCULATED", envir = .GlobalEnv) &&
  ...
  cat("restart the R session\n")
  cat("then run the complexity calculation again\n")
  cat("\n")
  cat("This will clear the .TASK_DATA_JUST_CALCULATED flag and allow complexity calculation.\n")
