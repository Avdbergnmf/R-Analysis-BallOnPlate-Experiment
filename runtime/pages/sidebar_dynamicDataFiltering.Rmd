...
#### Step Filtering
Note: Time slicing is now fully implemented for gait parameters, task metrics, and complexity metrics.
```{r}
...
actionButton("recompute_metrics", "🔄 Recompute Metrics with Slicing", class = "btn-primary", style = "margin-top: 10px;")
bsTooltip("recompute_metrics", 
          "Recompute task and complexity metrics using the current slicing settings. This may take a while.", 
          placement = "right", 
          trigger = "hover")
```
