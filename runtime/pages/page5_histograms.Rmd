...
# Create simulation data cache manager (with parallel processing disabled by default)
sim_cache_manager <- create_shiny_cache_manager("simulation", parallel = FALSE)
