...
updatePlotOptions <- function(xtracker, ytracker, target_x, target_y, current_x = NULL, current_y = NULL) {
  ...
  updateSelectInput(session = getDefaultReactiveDomain(), target_x, choices = xchoices, selected = selected_x)
  updateSelectInput(session = getDefaultReactiveDomain(), target_y, choices = ychoices, selected = selected_y)
}
