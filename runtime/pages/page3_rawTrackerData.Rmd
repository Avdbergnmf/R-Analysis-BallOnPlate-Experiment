...
output$TwoD <- renderSVG({
  reactive({
    plotting$plot_2d(input$tracker, input$tracker, input$participant2d, as.numeric(input$trialNum2d), input$xplot2d, input$yplot2d, input$plotlines, input$plotpoints, baseSize = input$baseSize)
  })
})
