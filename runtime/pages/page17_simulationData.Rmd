  ...
  tryCatch(
    {
      ...
      model <- simulation$train_and_save_risk_model(
        ...
        standardized_condition = if (isTRUE(input$enable_standardized_training) && !is.null(input$standardized_condition)) input$standardized_condition else NULL,
        standardized_phase = if (isTRUE(input$enable_standardized_training) && !is.null(input$standardized_phase)) input$standardized_phase else NULL
      )
