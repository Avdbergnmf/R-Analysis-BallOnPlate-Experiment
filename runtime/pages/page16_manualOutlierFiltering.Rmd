...
div(style = "font-size: 11px; color: #666; margin-top: -5px; margin-bottom: 10px;",
    "✓ Checked: Overwrites outliers_heelstrikes.csv and outliers_steps.csv",
    br(),
...
observeEvent(input$manual_backup, {
  ...
  backup_message <- paste0(
    ...
    "  → Will save to: ", file.path(dataExtraFolder, "outliers_heelstrikes.csv"), "\n\n",
    "• Step Outliers: ", num_step, " entries\n",
    "  → Will save to: ", file.path(dataExtraFolder, "outliers_steps.csv"), "\n\n",
  ...
  showModal(modalDialog(
    ...
    HTML(paste0(
      ...
      "   → File: <code>", file.path(dataExtraFolder, "outliers_heelstrikes.csv"), "</code><br><br>",
      "◐ <strong>Step Outliers:</strong> ", num_step, " entries<br>", 
      "   → File: <code>", file.path(dataExtraFolder, "outliers_steps.csv"), "</code><br><br>",
