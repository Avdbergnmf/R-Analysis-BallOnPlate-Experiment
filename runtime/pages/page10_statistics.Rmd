...
textInput("customModel", "Custom Model Formula: dependent_variable ~ ", value = "condition * (trialNum) + (1 | participant)")
...
observe({
  ...
  # Use regular variable names instead of non-existent diff variables
  updateSelectizeInput(session, "depVar", choices = cols , selected = "stepWidths.sd")
  updateSelectizeInput(session, "indepInterVars", choices = cols, selected = "condition")
